...
import { addProduct, deleteProduct, editProduct, getOwnerInventory, getSingleProduct, getStoreProducts } from "../controllers/product.js";
...
router.get('/my-inventory/:storeId', generalLimiter, verifyToken, verifyStoreOwner, getOwnerInventory);
router.put("/:productId", creationLimiter, verifyToken, verifyStoreOwner, editProduct)
router.delete("/:storeId/:productId", verifyToken, verifyStoreOwner, deleteProduct)
